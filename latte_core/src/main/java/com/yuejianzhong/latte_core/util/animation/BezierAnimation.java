package com.yuejianzhong.latte_core.util.animation;
...
public class BezierAnimation {
    ...
    public static void addCart(LatteDelegate fragment, View start, View end,
        ...
        final ViewGroup anim_mask_layout = BezierUtil.createAnimLayout(fragment.getProxyActivity());
        anim_mask_layout.addView(target);
        final View v = BezierUtil.addViewToAnimLayout(fragment.getContext(), target, startXY, true);
        if (v == null) {
            return;
        }
        /* 终点 */
